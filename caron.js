...
scripts.bull = {
  lua: [
    ...
    'redis.call("HMSET", "bull:" .. jqueue .. ":" .. jobId, "data", cjson.encode(cmsg), "opts", cjson.encode(jopts), "progress", 0, "delay", jdelay, "timestamp", ARGV[2], "attempts", jattempts, "attemptsMade", 0, "stacktrace", "[]", "returnvalue", "null")',
    'if jdelay > 0 then',
