...
scripts.bull = {
  lua: [
    ...
    'redis.call("HMSET", "bull:" .. jqueue .. ":" .. jobId, "data", cjson.encode(cmsg), "opts", "{}", "progress", 0, "delay", jdelay, "removeOnComplete", jopt0, "timestamp", ARGV[2], "attempts", jattempts, "attemptsMade", 0, "stacktrace", "[]", "returnvalue", "null")',
    'if jdelay > 0 then',
